...
not_skewed_key_spans as (
  ...
  inner join link_key_group_sizes
    on identity_link_key_spans.scope = link_key_group_sizes.scope
    and identity_link_key_spans.scope_value = link_key_group_sizes.scope_value
    and identity_link_key_spans.key_name = link_key_group_sizes.key_name
...
select
  source_key_span.scope,
  source_key_span.scope_value,
...
inner join not_skewed_key_spans as target_key_span
  ...
  and source_key_span.scope_value = target_key_span.scope_value
  and source_key_span.key_name = target_key_span.key_name
